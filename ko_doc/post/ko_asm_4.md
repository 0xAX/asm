...
이번 튜토리얼에서는 x86_64 어셈블리에서 문자열을 뒤집는 방법을 배웠습니다.
문자열을 바이트 배열로 다루는 기본 기술을 익히며, 스택과 레지스터를 활용하는 법을 배웠습니다. 그리고
문자열 처리 명령어와 기법들을 통해 어셈블리 언어와 한 발자국 친해졌다고 생각합니다 :)

계속해서 포기하지 않고 실력을 쌓길 바랍니다!
