...
Burada 1'i rax registera ve 2'yi de rdx registerına koyduk. Sonra registerların değerlerini stack'e pushluyoruz.Stack, LIFO (Last In First Out) olarak çalışır. Bu yüzden bu stack'in ya da uygulamamızın aşağıdaki yapıya sahip olması:
